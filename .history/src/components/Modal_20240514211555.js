...
const ModalComponent = (props) => {
  ...
  return (
    <div >
      <Button variant={props.color} onClick={handleShow} className='rounded-pill' size={props.size}>
        {props.title}
      </Button>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          {props.title === 'Delete' ? <p>Are you sure you want to delete this task?</p> : null}
